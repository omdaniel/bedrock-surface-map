...
detail. If visible detail and required shadow coverage do not fit, the viewer
asks the user to zoom in rather than silently clipping shadows. This budget is
